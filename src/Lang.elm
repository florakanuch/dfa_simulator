...
translations lang =
    case lang of
        EN ->
            ...
            , testString = "String Processing Simulation"
            , enterTestWord = "Enter input string..."
            , loadDfa = "⚙ Load DFA"
            , autoRun = "Auto run"
            , run = "▶ Run"
            , stop = "⏹ Stop"
            ...
            , helpDeleteBody = "Click on a state or transition to delete it. You can also delete elements in other draw modes — if your cursor is hovering over a state or transition, click the Delete button or Backspace on your keyboard. The hovered element will turn red to indicate it can be deleted. This is not a bug and you can continue drawing normally."
            , helpRename = "✎ Rename"
            ...
            , helpRedoItem = "↪ Redo"
            , helpRedoBody = "Redo a previously undone action. You can also use Ctrl+Y or Ctrl+Shift+Z."
            ...
            , helpTestWord = "Input string"
            , helpTestWordBody = "Type the string you want to process (e.g. \"aab\")."
            ...
            , helpStatusTestPanel = "Shown in the String Processing Simulation panel and updates continuously as the simulation runs."
            ...
            , helpIndexGeneral = "Shows which character position in the input string the simulation is currently at (e.g. 2 / 4)."
            , helpIndexTestPanel = "Counts the characters of the string entered in the Input String field."
        ...
        SK ->
            ...
            , testString = "Simulácia spracovania vstupu"
            , enterTestWord = "Zadaj vstupný reťazec..."
            , loadDfa = "⚙ Načítať DKA"
            ...
            , helpRedoItem = "↪ Znova"
            , helpRedoBody = "Zopakuje predtým vratenú akciu. Môžeš použiť aj Ctrl+Y alebo Ctrl+Shift+Z."
            ...
            , helpTestWord = "Vstupný reťazec"
            , helpTestWordBody = "Zadaj reťazec, ktorý chceš otestovať (napr. \"aab\")."
            ...
            , helpStatusTestPanel = "Zobrazený v paneli Simulácia spracovanie vstupu, priebežne sa aktualizuje počas simulácie."
            ...
            , helpIndexTestPanel = "Počíta znaky vstupného reťazca."
            ...
            , statusTestLabel = "Vstupný reťazec: "
